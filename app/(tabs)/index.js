...
import { View, Text, StyleSheet, Pressable, useWindowDimensions, ImageBackground, ScrollView, TextInput, Alert, Linking, Animated, Platform } from 'react-native';
...
// const [productselectedCategory, setproductSelectedCategory] = useState('necklaces');
  ...
  const getResponsiveStyles = (currentWidth) => ({
    ...
    offerBadge: {
      ...
      top: currentWidth < 400 ? spacing.xxl : 260,
      right: currentWidth < 400 ? spacing.sm : 230,
  ...
  const categories = ['Best Sellers', 'Most Popular'];
  ...
  const CATEGORY_SECTIONS = [
    {title: 'Bracelets', categoryId: 'bracelets'},
    {title: 'Necklaces', categoryId: 'necklaces'},
    {title: 'Earrings', categoryId: 'earrings'},
    {title: 'Rings', categoryId: 'rings'},
    {title: 'Jewellery Set', categoryId: 'jewellery_set'},
  ];

  const [productselectedCategory, setproductSelectedCategory] =
    useState('necklaces');
        ...
        <View style={styles.content}>
          <ImageBackground
            source={{
              uri:
                width < 600
                  ? 'https://fhybeyomiivepmlrampr.supabase.co/storage/v1/object/public/products/Three-Pcs-Jewellery-Set/1-three-piece-jewellery-set-4.avif'
                  : 'https://fhybeyomiivepmlrampr.supabase.co/storage/v1/object/public/products/Three-Pcs-Jewellery-Set/1-three-piece-jewellery-set-4.avif',
            }}
            ...
            <View style={styles.heroContent}>
              <Animated.View
                ...
                <Text style={styles.heroSubtext}>
                  Personalized, affordable luxury for birthdays, Mother's Day,
                  weddings & more
                </Text>
              </Animated.View>
          ...
          <View
            ...
            <ProductHighlightSection
              // title="Silver Round Bracelet For Women"
          ...
          <View
            style={[styles.tabContainer, isDesktop && {flexDirection: null}]}>
            <ScrollView
              horizontal
              ...
              {productcategories.map(cat => (
                <Pressable
                  key={cat}
                  onPress={() => setproductSelectedCategory(cat)}
                  style={[
                    styles.tab,
                    productselectedCategory === cat && styles.activeTab,
                  ]}>
                  <Text
                    style={[
                      styles.tabText,
                      productselectedCategory === cat && styles.activeTabText,
                    ]}>
                    {formatTitle(cat)}
                  </Text>
                </Pressable>
          ...
          {!isDesktop && (
            <View style={styles.scrollHintDots}>
          ...
          {CATEGORY_SECTIONS.filter(
            section => section.categoryId === productselectedCategory,
          ).map(section => (
          ...
          {selectedCategory === 'Best Sellers' && (
            <BestSellersSection
              ...
              bestSellerIds={[
                '4-rings',
                '2-bracelets',
                '7c430a41-726e-4753-8214-36ffc77303cb',
                'ec75311c-c851-45b8-b1a5-22a364e12449',
              ]}
              onAddToCartSuccess={handleShowCartModal}
            />
            // <BestSellersSection
          ...
          {selectedCategory === 'Most Popular' && (
            <MostPopularSection
              ...
              mostPopularIds={[
                ...
                '3-earrings',
                '5-brooch',
                '8d2e6c5b-1234-4cde-9876-abcdef123456',
                '1-earrings',
                '3-bracelets',
                '4-bracelets',
              ]}
          ...
          {/* {selectedCategory === 'Top Trending' && (
            <TopTrendingSection
              cardWidth={cardSize}
              numColumns={columns}
              trendingIds={['trend-1', 'trend-2', '3-bracelets', '4-bracelets']}
              onAddToCartSuccess={handleShowCartModal}
            />
          )} */}
          ...
          <View
            ...
            <ProductHighlightSection
              title="Silver Round Rings For Women"
              description="Made from high-quality silver, each ring is designed to offer lasting shine, durability, and comfort. Whether worn alone for a minimalist look or stacked for a bold statement, these rings are a must-have in every woman’s jewelry collection."
              // stepStart="01"
              // stepEnd="05"
              imageUri="https://fhybeyomiivepmlrampr.supabase.co/storage/v1/object/public/products/Rings/28-ring-4.avif"
              onAddToCart={() => {
                router.push('/shop?category=rings');
                // or your addToCart() logic
              }}
            />
          </View>
          ...
          <FeatureTiles
            ...
            onTilePress={(idx, feature) =>
              setFeatureModal({open: true, idx, feature})
            }
          />
          <FooterSection
            onSubscribe={email => console.log('Subscribed with:', email)}
            socialLinks={['facebook', 'instagram', 'linkedin', 'threads']}
          />
          ...
          {/* <View style={styles.newsletterSectionRedesign}>
            ...
            />
            <Text style={styles.newsletterTitleRedesign}>
              Join our newsletter
            </Text>
            <Text style={styles.newsletterSubtitle}>
              Exclusive offers, new arrivals & more. Only the good stuff!
            </Text>
            <View style={styles.newsletterFormRedesign}>
              ...
              <Pressable
                style={({pressed}) => [
                  styles.newsletterButtonRedesign,
                ...
                <Text style={styles.newsletterButtonTextRedesign}>
                  Subscribe
                </Text>
              </Pressable>
            </View>
            <View style={styles.socialRowRedesign}>
              <Pressable
                onPress={() =>
                  Linking.openURL(
                    'https://www.facebook.com/profile.php?id=61573565127513',
                  )
                }
              ...
              <Pressable
                onPress={() =>
                  Linking.openURL('https://instagram.com/rarecollectablesshop')
                }
                style={styles.socialIconRedesign}
                accessibilityRole="link"
        ...
        <Pressable
          style={[
            styles.chatButton,
            {
              ...
              borderRadius: isDesktop ? 35 : isTablet ? 32.5 : 30,
            },
          ]}
        ...
        {featureModal?.feature && (
          <View
            ...
            <View
              ...
              <FontAwesome
                name={featureModal.feature.icon}
                size={44}
                color={'#bfa14a'}
              />
            </View>
                    ...
                    <>
                      <Text
                        ...
                        <FontAwesome
                          ...
                          color="#bfa14a"
                        />{' '}
                        100% genuine, handpicked collectables. Each piece is
                        meticulously inspected for authenticity and
                        craftsmanship, ensuring it will be treasured for
                        generations.
                      </Text>
                      <Text
                        style={{
                        ...
                        <FontAwesome name="star" size={14} color="#bfa14a" />{' '}
                        5,000+ delighted collectors trust us.
                      </Text>
                      <Text
                        style={{
                          fontSize: 14,
                  ...
                  return (
                    <>
                      <Text
                        ...
                        <FontAwesome name="truck" size={16} color="#bfa14a" />{' '}
                        Enjoy fast, tracked UK delivery on every order—always
                        free, no minimum spend.
                      </Text>
                      <Text
                        style={{
                          fontSize: 15,
                        ...
                        <FontAwesome name="clock-o" size={14} color="#bfa14a" />{' '}
                        Most items are dispatched in 1-2 working days.
                      </Text>
                      <Text
                        style={{
                          fontSize: 14,
                      ...
                      <Text
                        ...
                        Shop today and your collectable will be on its way in no
                        time!
                      </Text>
                      <Pressable
                        onPress={() => {
                  ...
                  return (
                    <>
                      <Text
                        ...
                        <FontAwesome name="undo" size={16} color="#bfa14a" />{' '}
                        Changed your mind? No problem. Return any item within 60
                      ...
                      <Text
                        ...
                        <FontAwesome
                          ...
                          color="#bfa14a"
                        />{' '}
                        Hassle-free, customer-first returns process.
                      </Text>
                      <Text
                        style={{
                          fontSize: 14,
                  ...
                  return (
                    <>
                      <Text
                        ...
                        <FontAwesome name="shield" size={16} color="#bfa14a" />{' '}
                        Every purchase is protected for life. If your
                        collectable ever fails to meet our standards, we’ll
                        repair or replace it—no charge.
                      </Text>
                      <Text
                        style={{
                          fontSize: 15,
                        ...
                        <FontAwesome
                          ...
                          color="#bfa14a"
                        />{' '}
                        Certificate of Authenticity provided for select
                        jewellery.
                      </Text>
                      <Text
                        style={{
                ...
                default:
                  return (
                    <Text
                      ...
                      {featureModal.feature.description}
                    </Text>
                  );
              }
            })()}
            <Text
              ...
              <FontAwesome name="lock" size={13} color="#bfa14a" /> Secure
              checkout & 100% satisfaction guarantee
            </Text>
            <Text
              style={{
                fontSize: 12,
              ...
              Tap the close button or outside the modal to close
            </Text>
          </View>
        )}
      </LuxuryModal>
