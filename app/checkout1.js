...
export default function CheckoutScreen() {
  ...
  const validateForm = () => {
    ...
    if (
      address.phone &&
      !/^\+?[0-9]{10,14}$/.test(address.phone.replace(/\s+/g, ''))
    ) {
            ...
            <View
              ...
              <View style={styles.reservationTimerContainer}>
                <Text style={styles.reservationTimerText}>
                  ...
                  Your order is reserved for {reservationMinutes}:
              ...
              <View style={styles.expressCheckoutContainer}>
                <Text style={styles.expressCheckoutTitle}>
                  Express checkout
                </Text>
              ...
              <CollapsibleSection
                ...
                <FormField
                  ...
                  value={contact.email}
                  onChangeText={text =>
                    handleInputChange('contact', 'email', text)
                  }
              ...
              <CollapsibleSection
                ...
                <View style={styles.formRow}>
                  <FormField
                    ...
                    onChangeText={text =>
                      handleInputChange('address', 'firstName', text)
                    }
                  ...
                  <FormField
                    ...
                    onChangeText={text =>
                      handleInputChange('address', 'lastName', text)
                    }
                ...
                <FormField
                  ...
                  onChangeText={text =>
                    handleInputChange('address', 'address1', text)
                  }
                ...
                <FormField
                  ...
                  onChangeText={text =>
                    handleInputChange('address', 'address2', text)
                  }
                ...
                <AddressAutocomplete
                  ...
                  onPostcodeChange={text =>
                    handleInputChange('address', 'postcode', text)
                  }
                ...
                <FormField
                  ...
                  value={address.phone}
                  onChangeText={text =>
                    handleInputChange('address', 'phone', text)
                  }
            ...
            <View
              ...
              <View style={styles.orderSummaryContainer}>
                ...
                <View style={styles.discountContainer}>
                  ...
                  <Pressable
                    style={[
                      ...
                      !coupon.trim() && styles.discountButtonDisabled,
                    ]}
                ...
                {couponStatus && (
                  <Text
                    style={
                      couponStatus.valid ? styles.successText : styles.errorText
                    }>
                    {couponStatus.valid
                ...
                <View style={styles.orderSummarySection}>
                  ...
                  {couponStatus?.valid && (
                    <View style={styles.summaryRow}>
                      ...
                      <Text style={[styles.summaryValue, {color: colors.ruby}]}>
...
function StripePaymentForm({
  ...
  useEffect(() => {
    if (stripe && elements) {
      ...
      console.log(
        'Using preferred payment method ID:',
        preferredPaymentMethodId,
      );
    }
  ...
  const handleStripeCheckout = async () => {
    ...
    if (!stripe || !elements) {
      setErrors({
        ...errors,
        payment: ['Stripe not initialized yet. Please try again.'],
      });
      return;
    }
    ...
    if (
      ...
      const firstEmptyField = !contact.name
        ? 'field-name'
        : !contact.email
        ? 'field-email'
        : !address.line1
    ...
    try {
      ...
      console.log(
        `Using preferred payment method ID: ${preferredPaymentMethodId}`,
      );
      ...
      if (errorMessage.includes('card was declined')) {
        ...
        errorMessage =
          'Your card has expired. Please update your card details or try another card.';
      } else if (errorMessage.includes('invalid')) {
        errorMessage =
          'Your card information appears to be invalid. Please check your details and try again.';
      }
