...
import { View, Text, StyleSheet, TextInput, Pressable, ActivityIndicator, Modal, Dimensions, Alert, Animated, KeyboardAvoidingView, Platform, ScrollView, useWindowDimensions } from 'react-native';
...
// ...
  ...
  const dynamicContainerStyle = {
    position: 'fixed',
    bottom: isDesktop ? 40 : isTablet ? 32 : '5%',
    left: isDesktop || isTablet ? 32 : '10%',
    right: isMobile ? '10%' : 'auto',
    width: isDesktop ? '30%' : isTablet ? '60%' : '80%',
    maxWidth: 520,
...
const styles = StyleSheet.create({
  container: {
    ...
    overflow: 'hidden',
    boxShadow:
      Platform.OS === 'web' ? '0 8px 32px 0 rgba(191,160,84,0.18)' : undefined,
  ...
  header: {
    ...
    boxShadow:
      Platform.OS === 'web' ? '0 2px 24px 0 rgba(191,160,84,0.07)' : undefined,
  },
  headerTitle: {
    fontSize: 22,
    fontWeight: '700',
  ...
  inputContainer: {
    ...
    marginBottom: 18,
    boxShadow:
      Platform.OS === 'web' ? '0 2px 12px 0 rgba(191,160,84,0.08)' : undefined,
